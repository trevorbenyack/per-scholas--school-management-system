            ...
            for (j = l.length; g < j; g++) {
                ...
                if ("table" === b)
                    ...
                    for (n = o.length; h < n; h++)
                        f = o[h],
                            f =
                                "cell" === b ? c.call(r, l[g], f.row, f.column, g, h) : c.call(r, l[g], f, g, h, m),
                        f !== k && e.push(f)
                }
            }
...
(function(f) {
    ...
    f.fn.dataTableExt.oApi.fnColReorder = function(a, b, c, e, g) {
        ...
        if (b != c)
            if (0 > b || b >= l)
                ...
                this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " +
                    c);
            else {
                j = [];
                d = 0;
    ...
    f.extend(i.prototype, {
        ...
        _fnConstruct: function() {
            ...
            for (e = 0; e < b; e++)
                e > this.s.fixed - 1 && e < b - this.s.fixedRight && this._fnMouseListener(e, this.s.dt.aoColumns[e].nTh),
        ...
        _fnMouseMove: function(a) {
            if (null === this.dom.drag) {
                if (5 > Math.pow(Math.pow(this._fnCursorPosition(a, "pageX") - this.s.mouse.startX, 2) + Math.pow(this._fnCursorPosition(a, "pageY") - this.s.mouse.startY, 2), 0.5))
                    return;
        ...
        _fnRegions: function() {
            ...
            for (var b = 0, c = this.s.aoTargets[0].x, e = 0, g = a.length; e < g; e++)
                ...
                a[e].bVisible && "none" !== a[e].nTh.style.display && (c += f(a[e].nTh).outerWidth(),
                    this.s.aoTargets.push({
                        x: c,
                        to: b
                    }));
    ...
    d.extend(i.prototype, {
        ...
        _modeChange: function(b, a, e) {
            ...
            if ("in-place" === b) {
                ...
                "in" === b ? (this._clone(a, e), c.floating.addClass("fixedHeader-floating").css("header" === a ? "top" : "bottom", this.c[a + "Offset"]).css("left", f.left + "px").css("width", f.width + "px"), "footer" === a && c.floating.css("top", "")) : "below" === b ? (this._clone(a,
        ...
        _scroll: function(b) {
            ...
            (f = !c.visible || a <= c.theadTop - this.c.headerOffset ? "in-place" : a <= c.tfootTop - c.theadHeight - this.c.headerOffset ? "in" : "below", (b || f !== this.s.headerMode) && this._modeChange(f, "header", b), this._horizontal("header", e)), this.c.footer && this.dom.tfoot.length))
...
(function(c) {
    ...
    function s(b, a, d) {
        ...
        if (l[e])
            return l[e];
        for (var c = [], b = b.cell(a, d).node().childNodes, a = 0, d = b.length; a < d; a++)
            c.push(b[a]);
        return l[e] = c
    }
    function r(b, a, c) {
        var e = a +
            "-" + c;
        if (l[e]) {
            for (var b = b.cell(a, c).node(), c = l[e][0].parentNode.childNodes, a = [], f = 0, g = c.length; f < g; f++)
                a.push(c[f]);
            c = 0;
    ...
    h.display = {
        ...
        childRowImmediate: function(b, a, d) {
            if (!a &&
                b.child.isShown() || !b.responsive.hasHidden())
                return b.child(!1), c(b.node()).removeClass("parent"), !1;
            b.child(d(), "child").show();
            c(b.node()).addClass("parent");
            return !0
    ...
    d.extend(k.prototype, {
        ...
        _mouseMove: function(c) {
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !== e)
                0 === e ? this.dom.target.prependTo(j) : (b = d.unique(i.rows({
                    page: "current"
                }).nodes().toArray()), e > this.s.lastInsert ?
                    this.dom.target.insertAfter(b[e - 1]) : this.dom.target.insertBefore(b[e])),
                    this._cachePositions(),
                    this.s.lastInsert = e;
            this._shiftScroll(c)
        },
...
(function(e) {
    ...
    k.register("scroller().pixelsToRow()", function(a, b, c) {
        var d = this.context;
        if (d.length && d[0].oScroller)
            return d[0].oScroller.fnPixelsToRow(a,
                b, c)
    });
...
(function(e) {
    ...
    g.select.init =
        function(a) {
            ...
            if (!0 === b)
                ...
                f = b,
                    i = !0;
            else if (e.isPlainObject(b) && (b.blurable !== h && (l = b.blurable), b.info !== h && (w = b.info), b.items !== h && (d = b.items), b.style !== h && (f = b.style, i = !0), b.selector !== h && (k = b.selector), b.className !== h))
                j = b.className;
            a.select.selector(k);
            a.select.items(d);
            a.select.style(f);
    ...
    e.each([{
        ...
        g.ext.selector[c.type].push(function(b, a, f) {
            ...
            for (var k = 0, i = f.length; k < i; k++)
                e = b[c.prop][f[k]],
                (!0 === a && !0 === e._select_selected || !1 === a && !e._select_selected) && g.push(f[k]);
            return g
        })
    });
    g.ext.selector.cell.push(function(a, c, b) {
        ...
        for (var e = 0, g = b.length; e < g; e++)
            d = a.aoData[b[e].row],
            (!0 === c && d._selected_cells && !0 === d._selected_cells[b[e].column] || !1 === c && (!d._selected_cells || !d._selected_cells[b[e].column])) && f.push(b[e]);
        return f
    });
