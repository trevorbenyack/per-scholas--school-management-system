        ...
        E = function() {
            ...
            return e.prototype.destroy = function() {
                ...
                for (var r, i, o = {
                    ...
                    var s = l[a];
                    if (r = s.getEventTarget(), i = void 0, "HTML" !== (i = r.tagName) && "BODY" !== i && !t.pointInsideRect(o, s.clientRect))
                        return !1
                }
                return !0
            }, e
            ...
            function n(n) {
                ...
                r.dragSelection = null,
                    ...
                    r.handleHitUpdate = function(e, n) {
                        ...
                        }(r.hitDragging.initialHit, e, o.pluginSystem.hooks.dateSelectionTransformers)) && r.component.isDateSelectionValid(a) || (l = !0, a = null)),
                            a ? o.dispatch({
                                type: "SELECT_DATES",
                                selection: a
                            }) : n || o.dispatch({
            ...
            o.subjectSeg = null,
                ...
                o.handlePointerDown = function(e) {
                    ...
                    o.relevantEvents = t.getRelevantEvents(s.state.eventStore, d),
                        ...
                        a.delay = e.isTouch && d !== i.props.eventSelection ? function(e) {
                    ...
                    a.setIgnoreMove(!g),
                        o.isDragging = g && e.subjectEl.classList.contains("fc-draggable")
                },
                ...
                o.handleHitUpdate = function(e, n) {
                    if (o.isDragging) {
                        ...
                        n || (a === l && S(i, e) && (s = null), o.dragging.setMirrorNeedsRevert(!s), o.dragging.setMirrorIsVisible(!e || !document.querySelector(".fc-mirror")), o.receivingCalendar = l, o.validMutation = s, o.mutatedRelevantEvents = c)
                    }
                },
        ...
        function n(n) {
            ...
            r.draggingSeg = null,
                ...
                r.handleHitUpdate = function(e, n, o) {
                    ...
                    d && (g = t.applyMutationToEventStore(l, a.eventUiBases, d, a), h.mutatedEvents = g, r.component.isInteractionValid(h) || (u = !0, d = null, g = null, h.mutatedEvents = null)),
                        g ? a.dispatch({
            ...
            function e(e, n) {
                ...
                this.receivingCalendar = null,
                    ...
                    this.handleHitUpdate = function(e, n, o) {
                        ...
                        }(e.dateSpan, r.dragMeta, l), d.mutatedEvents = t.eventTupleToStore(s), (c = !t.isInteractionValid(d, l)) && (d.mutatedEvents = t.createEmptyEventStore(), s = null))),
                            r.displayDrag(l, d),
