                ...
                for (n = 0; n < f; n++) {
                    if (i = u[n], o = 0, s = document.createElement("tr"), m.push([]), y.push([]), v.push([]), i)
                        for (l = 0; l < i.length; l++) {
                            ...
                            }, a.el), w !== S ? d.colSpan = S - w + 1 : v[n][o] = d; o <= S;)
                                y[n][o] = d,
                                    m[n][o] = a,
                                    o++;
                            s.appendChild(d)
    ...
    var h = function(e) {
        ...
        p = function(e) {
            ...
            return n(r, e), r.prototype.renderSegs = function(t, r) {
                ...
                d > 0 && t.appendToElement(o, new Array(d + 1).join('<td style="pointer-events:none"></td>')),
                    r.el.colSpan = c - d,
                    o.appendChild(r.el),
                c < l && t.appendToElement(o, new Array(l - c + 1).join('<td style="pointer-events:none"></td>'));
        ...
        u = function(e) {
            ...
            return n(r, e), r.prototype.render = function(e) {
                ...
                this.el.innerHTML = '<div class="fc-header ' + r.getClass("popoverHeader") + '"><span class="fc-title">' + t.htmlEscape(n) + '</span><span class="fc-close ' + r.getIconClass("close") + '"></span></div><div class="fc-body ' + r.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>',
    ...
    var y = t.createFormatter({
        ...
        b = function(e) {
            ...
            return n(r, e), r.prototype.render = function(e) {
                ...
                (e || this.isCellSizesDirty || this.view.calendar.isEventsUpdated) && (this.buildPositionCaches(), this.isCellSizesDirty = !1),
                    t.computeSizes(e),
                    r.computeSizes(e),
                    n.computeSizes(e),
                    t.assignSizes(e),
                ...
                var n,
                    ...
                    R = function(n) {
                        for (; E < n;)
                            (a = v.getCellSegs(e, E, r)).length && (h = i[r - 1][E], y = v.renderMoreLink(e, E, a), m = t.createElement("div", null, y), h.appendChild(m), C.push(m)),
                                E++
                    };
                ...
                o = 1 === this.rowCnt ? c.el : this.rowEls[e],
                    ...
                    this.isRtl ? l.right = t.computeRect(f).right + 1 : l.left = t.computeRect(f).left - 1,
